...
if(isset($_POST['username'])) {
    ...
    if(mysqli_num_rows($cek) > 0) {
        ...
        $_SESSION['user'] = $data;
        echo '<script>alert("Selamat datang, Jangan lupa logout setelah menggunkan halaman ini"); location.href="index.php"</script>';
    }else{
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.php">Beyum punya akun? register!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
