<?php
   $id = $_GET['id'];
   if(isset($_POST['nama_pelnggan'])) {
    $nama = $_POST['nama_pelnggan'];
    $alamat = $_POST['alamat'];
    $no_telepon = $_POST['no_telepon'];

    $query = mysqli_query($koneksi, "UPDATE pelanggan SET nama_pelnggan='$nama',alamat='$alamat', no_telepon='$no_telepon' WHERE id_pelanggan=$id");
    if($query) {
        ...
        <form method="post">
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <td width="1">:</td>
                    <td><input class="form-control" value="<?php echo $data['nama_pelnggan']; ?>" type="text" name="nama_pelnggan"></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>:</td>
