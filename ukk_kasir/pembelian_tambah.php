...
if(isset($_POST['id_pelanggan'])){
    ...
    $query = mysqli_query($koneksi, "INSERT INTO penjualan(tanggal_jual, id_pelanggan) VALUES ('$tanggal', '$id_pelanggan')");

    $idTerakhir = mysqli_fetch_array(mysqli_query($koneksi, "SELECT*FROM penjualan ORDER BY id_penjual DESC"));
    $id_penjualan = $idTerakhir['id_penjual'];
    ...
    $query = mysqli_query($koneksi, "UPDATE penjualan SET total_harga=$total WHERE id_penjual=$id_penjualan");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        while($pel = mysqli_fetch_array($p)) {
                                            ?>
                                            <option value="<?php echo $pel['id_pelanggan']; ?>"><?php echo $pel['nama_pelnggan']; ?></option>
                                            <?php
                                        }
